...
A 2019. október 13-án megtartott helyi önkormányzati képviselők és polgármesterek, valamint nemzetiségi önkormányzati képviselők választására fordított pénzeszközök tervezése, felhasználása, elszámolása és annak ellenőrzése szabályszerű volt.
...
Az esetlegesen feltárt szabályozási és kontroll hiányosságok bemutatásával az ellenőrzés hozzájárulhat azok kijavításához, támogatva a „jól irányított állam” működését, valamint közvetetten a választások előkészítése és lebonyolítása során a közpénzek felhasználásával kapcsolatos közbizalom erősítését.
...
Az NVI elnöke az Áht. ${ }^{9}$ előírásai szerint, az Ávr. ${ }^{10}$ előírásaival összhangban, az államháztartásért felelős miniszter egyetértésével meghatározta a fejezeti kezelésű előirányzat felhasználásának szabályzatát ${ }^{11}$. Az NVI
 a helyi önkormányzati választás céljára szolgáló pénzeszközök elkülönített számviteli kezelését a Pvr. előírásai szerint kialakította.
...
Az NVI Számviteli politikájában ${ }^{13}$ rögzítették az előirányzat-módosítások szabályait az Áht.-ban előírtak szerint.

Az NVI a választás kommunikációs és információs rendszerét, valamint a választási pénzügyi-logisztikai rendszerét a KIM rendelet ${ }^{14}$ előírásai szerint működtette. A VÁKIR/VPIR ${ }^{15}$ rendszer működtetését a választási irodák részére felhasználói kézikönyv támogatta.

Az NVI a helyi önkormányzati választás előkészítése során lefolytatott beszerzések, szolgáltatásvásárlások, beruházások esetében a jogszabályi előírásokat betartotta. A minősített adatot tartalmazó beszerzésekhez a jogszabályok szerint az NBF ${ }^{16}$ előzetes engedélyével rendelkeztek.
...
## A VÁLASZTÁS ELŐKÉSZÍTÉSÉHEZ ÉS LEBONYOLÍTÁSÁHOZ KAPOTT PÉNZESZKÖZÖK FELHASZNÁLÁSÁNAK BELSŐ SZABÁLYZATAIT 

és az ellenőrzési jogkörök gyakorlásának szabályait a választási irodák az Áht., az Ávr. és a Pvr. előírásai szerint kialakították. A választási irodák rendelkeztek a gazdálkodási és ellenőrzési jogkörök gyakorlására vonatkozó szabályzatokkal, továbbá a gazdálkodási jogkör gyakorlására jogosultakról az Ávr.-ben előírt nyilvántartást vezették.
...
A választási irodák a helyi önkormányzati választással kapcsolatos pénzeszközök felhasználása során az Áht., az Ávr. és a belső szabályzatokban előírtakat betartották. A kiadások felhasználásánál az arra jogosultak gyakorolták a gazdálkodási jogköröket, a kötelezettségvállalást és a teljesítés igazolását.
...
A választási irodák a személyi és a dologi kiadások teljesítésénél a Pvr.-ben előírt jogcímek és normatívák szerinti összegeket érvényesítették. A pénzeszközök felhasználása a helyi önkormányzati választással összefüggésben történt.
...
## A TVI-K ÉS HVI-K A FELADATTÍPUSÚ ELSZÁMOLÁSI KÖTELEZETTSÉGÜKNEK 

a Pvr. előírásai és az NVI által előírtak szerint, határidőben tettek eleget.
...
A TVI-k a helyi választási irodák tekintetében a Pvr.-ben előírt ellenőrzési feladatokat ellátták. A TVI-k és HVI-k a pénzeszközök felhasználásának ellenőrzésére a választási iroda tagja részére a Pvr. előírásainak megfelelően megbízást adtak.
...
1. Egyházaskozári Közös Önkormányzati Hivatal (Tófürdő vonatkozásában)
...
11. Mezőladányi Közös Önkormányzati Hivatal (Újkenéz vonatkozásában)
...
18. Szentlőrinci Közös Önkormányzati Hivatal
...
a helyi önkormányzati képviselők és polgármesterek, valamint nemzetiségi önkormányzati képviselők 2019. október 13-ai választása
...
Állami Számvevőszék
a helyi önkormányzati képviselők és a polgármesterek általános választása, valamint a nemzetiségi önkormányzati képviselők általános választása költségeinek normatíváiról, tételeiről, elszámolási és belső ellenőrzési rendjéről szóló 22/2019. (VII. 31.) IM rendelet (hatályos: 2019. augusztus 01-től)
...
NVI 8/2019.(IX.16.) számú elnöki utasítása a helyi önkormányzati képviselők és polgármesterek általános választása, valamint a nemzetiségi önkormányzati képviselők általános költségeinek normatíváiról, tételeiről, elszámolási és belső ellenőrzési rendjéről szóló 22/2019.(VII.31.) IM rendeletben foglalt feladatok végrehajtásával kapcsolatos teendőkről
Nemzeti Választási Iroda Számviteli politika
...
ÁLLAMI SZÁMVEVŐSZÉK
1052 Budapest, Apáczai Cs. J. u. 10. | 1364
