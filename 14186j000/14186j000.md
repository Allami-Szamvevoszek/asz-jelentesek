...
A Nemzetiségi Önkormányzat és a XIII. Kerületi Önkormányzat együttmúködésének szabályozása, a múködési feltételek biztosítása megfelelt a jogszabályi előírásoknak. A Nemzetiségi Önkormányzat rendelkezett a 2012. év folyamán hatályban lévő együttmúködési megállapodással a XIII. Kerületi Önkormányzattal. A 2012. január 1-jén hatályos, 2010. december 9-én megkötött együttmúködési megállapodás ${ }_{1}$-nek a gazdálkodási szabályok változása miatti felülvizsgálatát, a Nek. tv.-ben előírt 2012. január 31-ei határidőn túl végezték el. A Nek. tv.-ben előírt kiegészítést végrehajtották, a 2012. június 1-jei határidőt betartva, 2012. február 24-én aláírták az együttmúködési megállapodás ${ }_{2}$-őt. Az együttmúködési megállapodás ${ }_{1,2}$-őt a Nemzetiségi Önkormányzat Képviselő-testülete határozattal elfogadta. A Nemzetiségi Önkormányzat múködésének feltételeit a jogszabályi előírásoknak megfelelően szabályozták a 2012. december 31-én hatályos megállapodás ${ }_{2}$-ben. A Nek. tv.-ben foglaltak ellenére azonban az együttmúködési megállapodás ${ }_{2}$ szerinti múködési feltételeket nem rögzítették a Nemzetiségi Önkormányzat SZMSZ-ében. A Nemzetiségi Önkormányzat gazdálkodási feladatai ellátásának szabályait, valamint a múködéshez szükséges személyi és tárgyi feltételeket az együttmúködési megállapodás ${ }_{2}$ tartalmazta.
...
A 2012. évben a Nemzetiségi Önkormányzat feladatellátásának tárgya összhangban volt a Nek. tv.-ben foglalt előírásokkal, kötelező feladatként közmeghallgatást, önként vállalt feladatként nemzetiségi fesztivált rendeztek.
...
elszámolása a támogatási kormányrendelet ${ }_{2} 8 . \S$ (5) bekezdésében hivatkozott „a helyi önkormányzatok elszámolási és ellenőrzési rendjére vonatkozó jogszabályok rendelkezései alkalmazandóak" előirása alapján az Áht. 64. § (7) bekezdése és az Áht. 2 57. § (3) bekezdése ellenére nem történt meg.
...
A Nemzetiségi Önkormányzat és a XIII. Kerületi Önkormányzat együttmüködésének szabályozása, a müködési feltételek biztosítása megfelelt a jogszabályi előírásoknak.

A Nemzetiségi Önkormányzat rendelkezett a 2012. év folyamán hatályban lévő együttműködési megállapodással a XIII. Kerületi Önkormányzattal. A 2012. január 1-jén hatályos, 2010. december 9-én megkötött együttműködési megállapodás ${ }_{1}$-nek a gazdálkodási szabályok változása miatti - évenként kötelező - felülvizsgálatát, a Nek. tv. 80. § (2) bekezdésében előírt 2012. január 31el határidőn túl végezték el. A Nek. tv. 159. § (3) bekezdésében előírt kiegészítést végrehajtották, a 2012. június 1-jei határidőt betartva, 2012. február 24-én aláírták az együttműködési megállapodás ${ }_{2}$-t.
...
A Nemzetiségi Önkormányzat müködésének feltételeit a jogszabályi előírásoknak megfelelően szabályozták a 2012. december 31-én hatályos együttműködési megállapodás ${ }_{2}$-ben. A Nek. tv. 80. § (2) bekezdésében foglaltak ellenére azonban az együttműködési megállapodás ${ }_{2}$ szerinti müködési feltételeket nem rögzítették a Nemzetiségi Önkormányzat SZMSZ-ében a megállapodás megkötését, módosítását követő 30 napon belül².
...
A XIII. Kerületi Önkormányzat az együttműködési megállapodás ${ }_{2}$-ben biztosította a Nemzetiségi Önkormányzat müködéséhez szükséges személyi és tárgyi feltételeket.
...
[^0]:    1 Az együttműködési megállapodás ${ }_{1}$-et a Nemzetiségi Önkormányzat 31/2010. (XI. 19.) számú határozatával, az együttműködési megállapodás ${ }_{2}$-t a 07/2012. (II. 8.) számú határozatával, a polgármester önkormányzati rendelet felhatalmazása alapján fogadta el.
    2 A Nemzetiségi Önkormányzat Szervezeti és Működési Szabályzatát a 17/2011. (VI.3.) számú határozattal fogadták el, további módosításra a 20112012 években, illetve a helyszíni ellenőrzés lezárásáig nem került sor.
...
A Nemzetiségi Önkormányzat elnöke a 2012. évi költségvetés tervezetét az Áht. ${ }_{2}$ előírása szerinti határidőben ${ }^{3}$ benyújtotta a Képviselő-testületnek. A jóváhagyott költségvetés ${ }^{4}$ az Áht. ${ }_{2}$-ben és az Ávr.-ben előírt tartalommal készült.

A jegyző által elkészített 2012. évi zárszámadási határozat-tervezetet a Nemzetiségi Önkormányzat elnöke az Áht. ${ }_{2}$-ben foglaltak alapján, határidőn belül terjesztette be a Képviselő-testületnek. Az Áht. ${ }_{2}$-ben előírt mérlegeket, kimutatásokat a zárszámadás előterjesztésekor tájékoztatásul bemutatták, és biztosították az összehasonlíthatóságát az elfogadott költségvetéssel. A zárszámadási határozatban ${ }^{5}$ a Nemzetiségi Önkormányzat valamennyi bevételét és kiadását bemutatták.
...
[^0]:    ${ }^{6}$ Számviteli politika, eszközök és források leltárkészítési és leltározási szabályzata, eszközök és források értékelési szabályzata, pénzkezelési szabályzat, számlarend, selejtezési szabályzat, önköltségszámítás rendjére vonatkozó szabályzat, ellenőrzési nyomvonal, szabálytalanságok kezelésének eljárásrendje, kockázatkezelési szabályzat, folyamatba épített előzetes, utólagos és vezetői ellenőrzés (FEUVE) szabályozás.
    ...
    ${ }^{8}$ A XXII/25-3/2010. (IV. 29.) számú, valamint az azt hatályon kívül helyező a XXII/111/2012. (VII. 02.) számú polgármesteri-jegyzơi együttes utasítás az Önkormányzat és a Polgármesteri Hivatal költségvetése végrehajtása során a kötelezettségvállalás és ellenjegyzés, a szakmai teljesítésigazolás, érvényesítés és utalványozás hatásköri rendjéről.
...
Az együttmúködési megállapodás ${ }_{2}$ rendelkezett a gazdálkodási jogkörök részletes kialakításáról ${ }^{9}$.
...
A Nemzetiségi Önkormányzat 2012. évi dologi kiadásai között a három legnagyobb összegű kiadás teljesítésekor - a bizonylatok egyedi értékelése alapján a teljesítésigazolás és az érvényesítés kulcskontrollok megfelelően múködtek.
...
[^0]
[^0]:    ${ }^{9}$ Az együttműködési megállapodás ${ }_{2}$ 24. pontja alapján a Nemzetiségi Önkormányzat előirányzatai terhére kötelezettséget vállalni és utalványozni kizárólag az elnök vagy az általa felhatalmazott nemzetiségi önkormányzati képviselö jogosult.
...
- **Equation:** $$\Delta T = q_p$$
  - Tₚ = Heat transferred at constant pressure.
  - Tₚₛ = Heat transferred at constant pressure.

### **Calorimetry of Enthalpy**

- **Equation:** $$\Delta T = q_p$$
  - Tₚₛ = Heat transferred at constant pressure.
  - Tₚₛₛₛ = Heat transferred at constant pressure.
...
| --- | --- | --- | --- |
|   | ezer Ft |  | megoszlás (\%)  |
|  Intézményi múködési bevételek | 0 | 8 | 8  |
|  Általános múködési támogatás | 215 | 215 | 215  |
|  Feladatalapú támogatás | 0 | 95 | 95  |
|  Támogatásért.múk. bev. helyi önkormányzattól | 3500 | 3500 | 3500  |
|  Előző évi pénzmaradvány átvétel | 0 | 191 | 191  |
|  Pénzeszköz átvétel áht-n kívülröl | 0 | 50 | 50  |
...
|  Munkaadókat terhelő járulékok és szocális hozzájárulási adó összesen | 603 | 600 | 598  |
...
| együttműködési megállapodás ${ }_{1}$ | A 2010. december 9-től érvényben lévő együttműködési megállapodás ${ }_{1}$. Az együttmúködési megállapodás ${ }_{1}$-et a Nemzetiségi Önkormányzat 31/2010. (XI. 19.) számú határozatával fogadta el. |
| együttműködési megállapodás ${ }_{2}$ | Az együttműködési megállapodás ${ }_{2}$-t 2012. február 24-én írták alá, az együttmúködési megállapodás ${ }_{2}$-őt a Nemzetiségi Önkormányzat 07/2012. (II. 8.) számú határozatával, a polgármester önkormányzati rendelet felhatalmazása alapján fogadta el. |
| EU | Európai Unió |
...
Budapest Főváros XIII. Kerületi Önkormányzat jegyzője XIII. Kerületi Horvát Nemzetiségi Önkormányzat Képvi-selő-testület
