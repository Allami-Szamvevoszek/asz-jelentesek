...
1. Az ellenőrzött szervezet az intézkedési tervben foglalt feladatokat - az elöirt határidőben - végrehajtotta-e?
...
- Az Intézkedési terv ${ }_{2} 1$. számú tervezett intézkedési feladata a Leltározási, Leltárkészítési és Selejtezési Szabályzata ${ }^{9}$ felülvizsgálatát határozta meg annak érdekében, hogy az Áhsz ${ }^{10}$ 37. § (4) bekezdésében foglaltaknak megfelelően tartalmazza a vagyonkezelésbe adott eszközök leltározására vonatkozó rendelkezéseket. A módosított Leltározási, leltárkészítési és selejtezési szabályzat megfelelt a jogszabály követelményeinek.
