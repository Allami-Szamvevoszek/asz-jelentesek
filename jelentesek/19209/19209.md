...
Pécsvárad Város Önkormányzata belső kontrollrendszerének kialakítása és működtetése nem volt szabályszerű, mivel a jogszabályi előírás ellenére a Pécsváradi Közös Önkormányzati Hivatal nem rendelkezett a feladatokat, a hatásköri és felelősségi viszonyokat meghatározó szervezeti és működési szabályzattal. A szabályozási hiányosság miatt nem volt biztosított a közpénzfelhasználás szabályossága és a nemzeti vagyonnal történő felelős gazdálkodás.
...
Pécsvárad Város Önkormányzata gazdálkodási feladatait ellátó Pécsváradi Közös Önkormányzati Hivatal működése kiterjedt Apátvarasd, Lovászhetény, Martonfa, Zengővárkony települések gazdálkodási feladatainak ellátására is.
...
Pécsvárad Város Önkormányzata és a gazdálkodási feladatokat ellátó Pécsváradi Közös Önkormányzati Hivatal belső kontrollrendszerének kialakítása és működtetése, valamint az integritás kontrollok kiépítettsége, a teljesítményellenőrzés feltételei.
...
Összegző megállapítás Az Önkormányzat ${ }^{9}$ belső kontrollrendszerének kialakítása és működtetése nem volt szabályszerű.

A BELSŐ KONTROLLRENDSZER kialakítása nem volt szabályszerű, mert a jegyző által elkészített Hivatali SZMSZ ${ }^{10}$-t az Áht. 9. § b) pontjában foglaltak ellenére a képviselő-testület nem hagyta jóvá, ezáltal a Hivatal ${ }^{11}$ nem rendelkezett az Áht. 10. § (5) bekezdése szerinti, szervezetét, feladatai ellátásának részletes belső rendjét és módját megállapító szervezeti és működési szabályzattal.
...
1. Gondoskodjon az Áht. előírásainak megfelelően a Közös Önkormányzati Hivatal jogszabályi előírásoknak megfelelő tartalmú szervezeti és működési szabályzatának Képviselő-testület elé terjesztéséről.
...
Az integritás
 az elvek, értékek, cselekvések, módszerek, intézkedések konzisztenciáját jelenti, vagyis olyan magatartásmódot, amely meghatározott értékeknek megfelel. (Forrás: Nemzetgazdasági Minisztérium: Magyarországi államháztartási belső kontroll standardok Útmutató 1.6.1. pontja, 2012. december)
