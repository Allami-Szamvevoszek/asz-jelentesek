...
Horvát Nemzetiségi Önkormányzat Sellye 2016. 05. hó 05. nap
...
A Nemzetiségi Önkormányzat működési feltételeinek és gazdálkodása végrehajtási feladatainak szabályozása a jogszabályi előírásoknak megfelelt.

A Nemzetiségi Önkormányzat

 rendelkezett hatályos együttműködési megállapodás ${ }_{1,2}$-vel. Az együttműködési megállapodás ${ }_{1}$-t 2014. január 31-ig nem, a 2014. évi választásokat követően határidőben felülvizsgálták.
...
Az együttműködési megállapodás ${ }_{2}$ szerinti működési feltételeket a Nemzetiségi Önkormányzat SZMSZ2-ben rögzítették.

A Nemzetiségi Önkormányzat rendelkezett hatályos, a szervezete és működése részletes szabályait rögzítő SZMSZ ${ }^{7}{ }_{1,2}$-vel.

A Nemzetiségi Önkormányzat - 41/2014. (XII. 16.) határozattal elfogadott - SZMSZ2-ben, a Nek. tv. 80. § (2) bekezdésében előírtak ellenére az együttműködési megállapodás ${ }_{2}$ megkötését követő 30 napon túl - 6 nappal meghaladva - rögzítették az együttműködési megállapodás ${ }_{2}$ szerinti Nemzetiségi Önkormányzatra vonatkozó működési feltételeket.
...
A zárszámadási határozat-tervezet előterjesztésekor a jogszabályi előírás ellenére tájékoztatásul az elnök nem mutatta be a Nemzetiségi Képviselő-testületnek:
...
| Sorszám | Adatszolgáltatás /jogszabályi előírás | Határidő | Teljesítés |
| :--: | :--: | :--: | :--: |
...
## A pénzügyi folyamatokban kulcsszerepet betöltő teljesítésigazolás és érvényesítés kontrollok nem működtek megfelelően.

A 2014. évben a Nemzetiségi Önkormányzatnál személyi juttatásokkal, dologi kiadásokkal, beruházással és egyéb működési célú kiadásokkal kapcsolatos kifizetésekre került sor. E kifizetéseknél a kulcsszerepet betöltő teljesítésigazolás és az érvényesítés kontrollok működése „nem megfelelő" volt. A gazdálkodási jogkörök gyakorlásának ellenőrzése során tapasztalt hiányosságokat, szabálytalanságokat a 2. táblázat részletezi.
2. táblázat
...
Az összesítés alapján az integritás
 kontrollrendszere fejlesztendő, melyet az ellenőrzés során tett megállapítások is alátámasztottak. Az operatív gazdálkodási jogkörök szabályozása és gyakorlása, Nemzetiségi Önkormányzat gazdálkodási feladatainak ellátása során feltárt hiányosságok és hibák arra utaltak, hogy a Nemzetiségi Önkormányzat működési és gazdálkodási kereteinek kialakításánál és működésénél további intézkedések megtétele szükséges az integritás szemlélet érvényesülése érdekében.
...
c) jogszabályi előírásoknak megfelelő határidőben az évközi és az éves államháztartási információs adatszolgáltatások teljesítéséről;
...
e) a pénzügyi folyamatokban kulcsszerepet betöltő teljesítésigazolás és érvényesítés belső kontrollok jogszabályi előírásoknak megfelelő működtetéséről;
(2.6. sz. megállapítás 2. táblázat alapján)
f) a gazdasági események jogszabályi előírásoknak megfelelő rögzítéséről a számviteli nyilvántartásokban.
...
|  Működési célú pénzeszközátadások államháztartáson kívülre (speciális célú pénzeszközátadás) | 0,0 | 10,0 | 10,0 | 100,0  |
|  Működési kiadások összesen | 721,0 | 2000,0 | 1664,0 | 83,2  |
...
3. A Horvát Nemzetiségi Önkormányzat Sellye Szervezeti és Működési Szabályzata, amelyet a Nemzetiségi Önkormányzat Képviselő-testülete a 2/2012. (I. 30.) számú határozatával fogadott el (hatályos: 2012. január 30-tól 2014. december 15-ig)
...
A Képviselő-testület 4/2013. (I. 10.) számú határozatával elfogadott Közös Önkormányzati Hivatali Szervezeti és
