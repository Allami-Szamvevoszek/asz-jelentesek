...
Gödöllői Német Nemzetiségi Önkormányzat 2016.
...
| Sorszám | Nek.tv.-i hivatkozás | Az együttmúködési megállapodás ${ }_{1,2}$-ben nem rögzítették |
| :--: | :--: | :--: |
| 1. | 80. § <br> (3) bekezdés a) pont | A nemzetiségi önkormányzat törzskönyvi nyilvántartásba vételével és adószám igénylésével kapcsolatos feladatok ellátásához rendelt határidőket, az együttmüködési kötelezettség és ezek felelőseinek konkrét kijelölését. |
...
| 3. | 80. § <br> (3) bekezdés d) pont | A nemzetiségi önkormányzat müködési feltételeinek és gazdálkodásának eljárási és dokumentációs részletszabályaival, valamint az ezeket végző személyek kijelölésének rendjével kapcsolatos előírásokat, feltételeket. |

---

| Sor- <br> szám | Nek.tv.-i <br> Invalkozás | Az együttmúködési megállapodás ${ }_{1,2}$-ben nem rögzítették |
| :--: | :--: | :--: |
|  |  | Annak rögzítését, hogy a jegyző vagy annak - a jegyzővel azonos |
|  | 80. § <br> (4) bekezdés | képesítési elöírásoknak megfelelő - megbízottja a helyi önkor- <br> mányzat megbízásából és képviseletében részt vesz a nemzetis- <br> ségi önkormányzat testületi ülésein és jelzi, amennyiben tör- <br> vénysértést észlel. |
...
A jegyző nem gondoskodott a Nemzetiségi Önkormányzat múködési folyamataira vonatkozó ellenőrzési nyomvonalnak, a szabálytalanságok kezelése eljárásrendjének, valamint a folyamatba épített, előzetes, utólagos és vezetői ellenőrzés szabályozásáról.
...
A jegyző által előkészített költségvetési határozat-tervezetet ${ }^{22}$ az elnök az Áht. 24. § (3) bekezdésében szereplő határidőt - négy nappal - túllépve nyújtotta be a Nemzetiségi Képviselő-testület részére. A Nemzetiségi Kép-viselő-testület által 1/2014. (II.20) számon elfogadott költségvetési határozat ${ }^{23}$ - néhány hiányossága ellenére - megfelelt a jogszabályi előírásoknak. Nem szerepeltették a költségvetési határozatban az Áht. 23. § (2) bekezdés c) pontjában foglaltak ellenére a költségvetési egyenleg összegét múködési és felhalmozási cél szerinti bontásban, illetve az Áht. 23. § (2) bekezdés h) pontja ellenére a költségvetés végrehajtásával kapcsolatos hatásköröket,
...
A Nemzetiségi Önkormányzatnál a személyi juttatásokkal, dologi kiadásokkal és egyéb múködési célú kiadásokkal kapcsolatos kifizetések esetében a gazdálkodási jogkörök gyakorlása nem megfelelő volt.

A 2014. évben a Nemzetiségi Önkormányzatnál személyi juttatásokkal, dologi és egyéb múködési célú kiadásokkal kapcsolatos kifizetésekre került sor. E kifizetéseknél a kulcsszerepet betöltő teljesítésigazolás és érvényesítés kontrollok múködése „nem megfelelő" volt. A gazdálkodási jogkörök gyakorlásának ellenőrzése során tapasztalt hiányosságokat, szabálytalanságokat a 4. táblázat részletezi.
4. táblázat
...
| :--: | :--: | :--: |
| 1. | teljesítésigazolás | A teljesítésigazolás az Ávr. 57. § (3) bekezdésének előirása ellenére az igazoló személy (Nemzetiségi Önkormányzat elnöke) aláírásán túl rendszerszerűen nem tartalmazta a teljesítés tényére történő utalást és az igazolás dátumát. |
...
Összegző megállapítás Az integritási szemlélet érvényesítésének erősítése érdekében a Nemzetiségi Önkormányzat múködési és gazdálkodási kereteinek kialakításánál és múködésénél további intézkedéseket kell tenni.
...
a) a Nemzetiségi Önkormányzat gazdálkodási feladataira vonatkozó ellenőrzési nyomvonal elkészitéséről, a szabálytalanságok kezelésének eljárásrendje szabályozásáról és a FEUVE jogszabályi előírásoknak megfelelő biztosításáról;
...
g) a pénzügyi folyamatokban kulcsszerepet betöltő teljesítésigazolás és érvényesítés belső kontrollok jogszabályi előírásoknak megfelelő müködtetéséről.
...
|  Megnevezés | Eredeti
előrányzat (szer Ft-ban) | Módosított
szer Ft-ban | Teljesítés |   |
| --- | --- | --- | --- | --- |
|   |  |  |  | \%-ban  |
|  BEVÉTELEK |  |  |  |   |
|  Intézményi múködési bevételek | 0,0 | 0,0 | 1,0 | -  |
...
|  Múködési bevételek összesen | 271,0 | 1026,0 | 1027,0 | 100,1  |
...
|  Múködési célú pénzeszközátadások államháztartáson kívülre | 20,0 | 20,0 | 20,0 | 100,0  |
|  Múködési kiadások összesen | 271,0 | 1192,0 | 646,0 | 54,2  |
...
Gödöllői Német Nemzetiségi Önkormányzat 2014. évi költségvetésének végrehajtásáról szóló 2014. évi 4/2015. (III. 17.) számú határozat
