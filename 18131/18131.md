...
$\qquad$ 6. A jogszabályi környezet változása miatt a víziközművek Önkormányzat tulajdonába való visszakerülése okafogyottá vált, mivel az új Vksz. ${ }^{11}$ törvény alapján a víziközmű 2013. január 1-jén az ivóvíz-ellátásért felelős Fővárosi Önkormányzat tulajdonába került.
...
- I. SZ. MELLÉKLET: BUDAPEST XXI. KERÜLET CSEPEL ÖNKORMÁNYZATA INTÉZKEDÉSI TERVÉNEK VÉGREHAITÁSA

|  1. | Intézkedési terv alapján elvégzendő feladat | Az intézkedési tervben meghatározott határidő | Az intézkedési tervben meghatározott felelős 3.  |
| --- | --- | --- | --- |
|   | 1. | 2. | 3.  |
|  Határidőben végrehajtott feladatok |  |  |   |
