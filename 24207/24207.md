...
Az időközi választások pénzügyi előkészítése során az ellenőrzött szervezeteknél a szabályszerű pénzfelhasználás kereteinek kialakítása megtörtént.
...
Az időközi választásokra felhasznált pénzeszközök ellenőrzése - három helyi választási irodát kivéve - szabályszerű volt.
...
5. A választási irodáknál az időközi választásokra felhasznált

 pénzeszközök ellenőrzésének szabályszerűsége
...
|  | FEJEZETI KEZELÉSŰ ELŐIRÁNYZAT | INTÉZMÉNYI ELŐIRÁNYZAT | ÖSSZESEN | FEJEZETI KEZELÉSŰ ELŐIRÁNYZAT | INTÉZMÉNYI ELŐIRÁNYZAT | ÖSSZESEN |
...
| MEGNEVEZÉS | 2022. ÉV
 |  | 2023. év |  |
|  | Fejezeti kezelésű előirányzat | Intézményi előirányzat | Fejezeti kezelésű előirányzat | Intézményi előirányzat |
...
- képviselői mandátum betöltésére, ha a képviselő-választáson kevesebb jelölt indult, vagy kevesebb jelöltet választottak meg, vagy a képviselők száma a képviselő-testület működéséhez szükséges létszám alá csökkent. (forrás: NVI honlapja).
A választást úgy kell kitűzni, hogy a szavazás napja a kitűzés napját követő 70. és 90. nap közé essen.

Az időközi választást az illetékes választási bizottság a mandátum megüresedésétől, a szavazás kitűzött napjától számított 120 napon belülre, vasárnapra tűzi ki.
...
| 12. | Miskolc Megyei Jogú Város Helyi Választási Iroda | Miskolc Megyei Jogú Város Polgármesteri Hivatala |
...
15/2019. (XII. 7.) PM rendelet a kormányzati funkciók és államháztartási
