...
GÉNEK javítása érdekében a Társaság ügyvezetője gondoskodott arról, hogy a munkavállalók részére továbbszámlázott magáncélú telefonköltség, valamint a közlekedési bírság munkavállaló által megtérített összegét a Számv. tv. ${ }^{7}$ előírásaival összhangban, a Társaság számlarendjében foglaltaknak megfelelően számolják el (4).

---

# MELLÉKLETEK

- I. SZ. MELLÉKLET: A SZÉCHENYI PROGRAMIRODA TANÁCSADÓ ÉS SZOLGÁLTATÓ NONPROFIT KFT. INTÉZKEDÉSI TERVE VÉGREHAJTÁSÁNAK ÉRTÉKELÉSE
